//
//  OrderStatusTabTableViewController.swift
//  Housefood
//
...
class OrderStatusTabTableViewController: UITableViewController, IndicatorInfoProvider {
    
    var itemInfo = IndicatorInfo(title: NavBarTitle.OrderStatus)
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: NibName.OrderStatusTableViewCell, bundle: nil), forCellReuseIdentifier: ReuseIdentifiers.OrderStatusTableViewCell)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: ReuseIdentifiers.OrderStatusTableViewCell, for: indexPath) as! OrderStatusTableViewCell
